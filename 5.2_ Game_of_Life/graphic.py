...
def fild_init (width=20, height=20): #game begin from fild building (width, height)
...
def cell_img_old(): # size of cell and color (width, height) l_ d_ - life and died colors
    ...
    for y in range(h):
        for x in range(w):
            ...
            if grid[y][x] == 1:
                ...
                fild_visual.paste(c_old, (x_pos, y_pos))
            else:
                fild_visual.paste(field_cond, (x_pos, y_pos))
